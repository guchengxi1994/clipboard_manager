...
#[no_mangle]
pub extern "C" fn wire_set_locale_path(port_: i64, s: *mut wire_uint_8_list) {
    wire_set_locale_path_impl(port_, s)
}

#[no_mangle]
pub extern "C" fn wire_get_locale(port_: i64) {
    wire_get_locale_impl(port_)
}

#[no_mangle]
pub extern "C" fn wire_set_locale(port_: i64, s: *mut wire_uint_8_list) {
